...
public class CityMarker extends CommonMarker {
	...
	public void showTitle(PGraphics pg, float x, float y){
		if (getCity().equals("Zaporozhje")){
			
			String name1 = "HELLO EVERYBODY, MY NAME IS DANIL";
			String pop1 = "AND THIS IS MY CITY, THIS IS ZAPOROZHYE";
			...
			pg.rect(x, y-TRI_SIZE-39, Math.max(pg.textWidth(name1), pg.textWidth(pop1)) + 6, 39);
			pg.fill(0, 0, 0);
			pg.textAlign(PConstants.LEFT, PConstants.TOP);
			pg.text(name1, x+3, y-TRI_SIZE-33);
			pg.text(pop1, x+3, y - TRI_SIZE -18);
